...
### v2.3.131 [ダウンロード](https://machanbazaar.com/wp-content/uploads/2026/09/YNCNEO_v2.3.131.zip)

・Gemini周りの修正（Gemini2.5がEoSを迎えるので、3.5をベースにしました）
・テンプレートの動作を修正
・辞書回りの動作修正

## 先行開発版をダウンロード

### v3.0.0 beta 12 [ダウンロード](https://machanbazaar.com/wp-content/uploads/2026/09/YNCNEO_v3.0.0-beta12.zip)

・設定を何度も書き換えると設定ファイルが壊れるパターンがあったので修正
・Gemini周りの修正（Gemini2.5がEoSを迎えるので、3.5をベースにしました）
・テンプレートの動作を修正
・プラグインのチェックを有効無効/削除に機能をわけました。
・プログラムのプラットフォーム変更で挙動が変わっている点の修正
・読み上げ/字幕受信周りの通信みなおし
