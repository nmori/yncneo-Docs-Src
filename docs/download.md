...
### v2.3.0 RC 5[ダウンロード](https://machanbazaar.com/wp-content/uploads/2025/08/YNCneo_v2.3.0_RC5.zip)

・支援版翻訳に必要な通信ができなくなっている部分の修正
　（支援版翻訳がうまく起動しない方はアップデート推奨）
・一部設定の保存・反映に失敗している点の修正
