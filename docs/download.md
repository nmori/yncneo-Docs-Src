...
### v2.0.91：[ダウンロード](https://machanbazaar.com/wp-content/uploads/2023/02/YNCneo_v2.0.91.zip)

主な修正：

* 設定のエクスポート範囲が指定可能に
* VRChatのジェスチャーに連動して声色変更可能に
* バーチャルキャストのOSCに対応
* UDトーク併用時のコンベアレイアウトの乱れを修正
* ホットキープラグインの発火条件に「クリア時」を追加
* 内部ソフト部品のセキュリティアップデート
