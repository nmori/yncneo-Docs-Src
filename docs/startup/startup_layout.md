...
### ショート
<!-- TODO: スクリーンショット未撮影。撮ったら images/startup_layout7.png として置き、次の行を有効にする -->
<!-- ![ショート](images/startup_layout7.png) -->

* 1行に1文字ずつ流し、行が埋まると左へスクロールします。
* 高さをとらないので、画面のすみに置く使い方に向いています。

### ショート(動き控えめ)
<!-- TODO: スクリーンショット未撮影。撮ったら images/startup_layout8.png として置き、次の行を有効にする -->
<!-- ![ショート(動き控えめ)](images/startup_layout8.png) -->

* 「ショート」と同じ見せ方ですが、文字が出るときの演出を抑えてちらつきを減らしています。
* 横幅を超えたときだけ左へスクロールします。
* 画面の動きが気になるゲーム配信に向いています。
