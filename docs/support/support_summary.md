...
支援時にFANBOXで得たキーワードを入力すると、支援プランに応じて、いくつかの翻訳エンジンが利用できます。
...
* 専属ソフトウェアサポートはありません。サポートDiscordコミュニティへ相談・提案ください。
* 各音声/翻訳エンジンのルールに沿って利用ください。
* 支援モードが業務時に使えなかった場合などの損失補償はありません。
* API側の保証が必要な場合は、各エンジン提供業者と契約ください。
